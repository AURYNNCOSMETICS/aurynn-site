...
const products = [
  ...
  },
  {
    ...
    price: "€24,95",
    bullets: ["Geschikt voor een gevoelige hoofdhuid", "Verrijkt met Pea Peptides & Aloe Vera", "Sulfaat- en siliconenvrij"],
    image: "https://images.unsplash.com/photo-1616394584738-fc6e612b3cfe?q=80&w=1200&auto=format&fit=crop",
  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur bg-[var(--base)]/80 border-b border-[var(--sand)]/60">
      <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
        <Link to="/" className="tracking-[0.25em] text-xl md:text-2xl font-serif" aria-label="Aurynn home">
          {brand.name}
        </Link>
    ...
    >
        ...
        <div className="mx-auto max-w-6xl px-4 py-24 md:py-28 grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h1 className="text-4xl md:text-6xl font-serif tracking-widest leading-tight">
              Moments of calm,<br /> created for you.
            </h1>
      ...
      <section id="faq" className="mx-auto max-w-5xl px-4 py-20">
        ...
        <div className="mt-8 divide-y divide-[var(--sand)]/70">
          {[
            { q: "Hoe lang is de levertijd?", a: "Bestellingen vanuit EU-warehouse worden in 2–5 werkdagen geleverd." },
            { q: "Kan ik retourneren?", a: "Ja, je hebt 14 dagen bedenktijd. Ongeopende producten kunnen kosteloos retour." },
            { q: "Welke betaalmethoden accepteert Aurynn?", a: "iDEAL, creditcard, PayPal en Apple Pay." },
          ].map((item, i) => (
  ...
  return (
    <main className="min-h-screen bg-[var(--base)] text-[var(--ink)]">
      ...
      <section className="mx-auto max-w-4xl px-6 py-20 text-center">
        ...
        <p className="mt-6 text-[var(--ink)]/80 leading-relaxed">
          Bij Aurÿnn geloven we dat rust en verzorging hand in hand gaan. Elk product is ontworpen als een moment van kalmte –
          geïnspireerd door natuurlijke eenvoud en tijdloze luxe.
        </p>
      </section>
      <SiteFooter />
    </main>
